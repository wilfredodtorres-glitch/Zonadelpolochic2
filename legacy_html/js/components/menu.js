    ...
    <div class="contenedor encabezado-inner">
      <a class="marca" href="index.html">
        <img class="logo-adventista logo-oscuro" src="imagenes/logo-adventista-oscuro.png"
          alt="Iglesia Adventista del Séptimo Día" width="180" height="52" />
        <img class="logo-adventista logo-claro" src="imagenes/logo-adventista-claro.png" alt="" width="180" height="52"
          aria-hidden="true" />
      </a>
